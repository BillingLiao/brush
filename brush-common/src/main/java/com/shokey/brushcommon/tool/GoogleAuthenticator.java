package com.shokey.brushcommon.tool;
...
public class GoogleAuthenticator {
    ...
    public static final int SECRET_SIZE = 10;//正式上线需要改动

    public static final String SEED = "g8GjEvTbW5oVSV7avL47357438reyhreyuryetredLDVKs2m0QN7vxRs2im5MDaNCWGmcD2rvcZx";//正式上线需要改动
    // Java实现随机数算法
