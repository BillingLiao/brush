...
public class CustomSecurityConfig {
    ...
    public static final String[] exclusivePaths = {"/fonts/**","/images/**","/js/**","/css/**","/vendors/**","/static/**", "/favicon.ico", "/tikesignup", "/login","/takelogin", "/401", "/404","/404","/500", "/signup", "/register.html","/test"};
    // cookie名字列表 退出时需要清除
